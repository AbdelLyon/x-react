      ...
      Popover,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(PopoverContent, { className: "rounded-md p-4", children: [
            ...
            /* @__PURE__ */ jsx(ScrollShadow, { className: "mt-4 max-h-64 w-72 overflow-x-hidden", children: /* @__PURE__ */ jsx("div", { className: "grid w-full grid-cols-3 gap-2", children: selectedItems.map((item) => {
              const itemKey = getItemKey(item);
