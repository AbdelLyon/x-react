const GRID_VARIANTS = {
  bordered: {
    ...
    th: "h-14 bg-content1-100 first:pl-4 px-4 py-4 text-left whitespace-nowrap backdrop-blur-sm border-b border-border/40 transition-all duration-200 group-hover:bg-content1-200",
