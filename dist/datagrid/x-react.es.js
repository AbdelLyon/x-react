...
var z = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new WeakMap(), _ = 0, J = void 0;
function N(e) {
...
function Q(e) {
  return Object.keys(e).sort().filter(
    (t) => e[t] !== void 0
  ).map((t) => `${t}_${t === "root" ? N(e.root) : e[t]}`).toString();
}
function X(e) {
  const t = Q(e);
  let l = z.get(t);
...
function Y(e, t, l = {}, r = J) {
  ...
  const { id: o, observer: c, elements: i } = X(l), s = i.get(e) || [];
