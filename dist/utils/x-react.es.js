...
const $ = "-", ne = (e) => {
  ...
  return {
    getClassGroupId: (a) => {
      const s = a.split($);
      return s[0] === "" && s.length !== 1 && s.shift(), Y(s, r) || se(a);
    },
  ...
  const t = e[0], o = r.nextPart.get(t), l = o ? Y(e.slice(1), o) : void 0;
  if (l)
    return l;
  ...
  return ae(Object.entries(e.classGroups), t).forEach(([n, a]) => {
    _(a, o, n, r);
  }), o;
}, _ = (e, r, t, o) => {
  e.forEach((l) => {
...
}, le = (e) => e.isThemeGetter, ae = (e, r) => r ? e.map(([t, o]) => {
...
function me(e, ...r) {
  ...
  function a(u) {
    ...
    return t = ue(g), o = t.cache.get, l = t.cache.set, n = s, s(u);
  }
  function s(u) {
    const g = o(u);
    if (g)
...
}, re = /^\[(?:([a-z-]+):)?(.+)\]$/i, he = /^\d+\/\d+$/, ye = /* @__PURE__ */ new Set(["px", "full", "screen"]), xe = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, we = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ve = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, Ce = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, ke = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, k = (e) => M(e) || ye.has(e) || he.test(e), z = (e) => G(e, "length", Pe), M = (e) => !!e && !Number.isNaN(Number(e)), O = (e) => G(e, "number", M), P = (e) => !!e && Number.isInteger(Number(e)), ze = (e) => e.endsWith("%") && M(e.slice(0, -1)), i = (e) => re.test(e), S = (e) => xe.test(e), Se = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Ae = (e) => G(e, Se, te), Me = (e) => G(e, "position", te), Ge = /* @__PURE__ */ new Set(["image", "url"]), Re = (e) => G(e, Ge, Te), Ie = (e) => G(e, "", je), j = () => !0, G = (e, r, t) => {
  const o = re.exec(e);
...
}, Le = /* @__PURE__ */ me(Ee), We = (...e) => Le(oe(e)), Ve = (e) => e.charAt(0).toUpperCase() + e.slice(1), Ue = (...e) => e.filter(Boolean).join(" "), Oe = (e, r) => e.startsWith(r), _e = (e, r) => e.endsWith(r), $e = (e) => e.toLowerCase(), Be = (e) => e.toUpperCase(), Fe = (e) => e.trim(), qe = (e) => e.split("").reverse().join(""), Je = (e, r, t) => r === void 0 && t === void 0 ? e : r !== void 0 && t === void 0 ? Math.max(e, r) : r === void 0 && t !== void 0 ? Math.min(e, t) : r !== void 0 && t !== void 0 ? Math.min(Math.max(e, r), t) : e;
function Xe(e, r = 0) {
  let t, o;
  function l(...n) {
    o = n, t !== void 0 && clearTimeout(t), t = setTimeout(() => {
      o && e.apply(this, o), t = void 0, o = void 0;
    }, r);
  }
  return l.cancel = function() {
    t !== void 0 && (clearTimeout(t), t = void 0, o = void 0);
  }, l;
}
export {
  Ve as capitalizeFirstLetter,
  We as cn,
  Ue as concatenateWithSpace,
  Xe as debounce,
  _e as endsWith,
  Je as limitValue,
  qe as reverse,
