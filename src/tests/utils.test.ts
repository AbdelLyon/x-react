...
describe("Utility Functions", (): void => {
  ...
  describe("Logging Utilities", (): void => {
    beforeEach((): void => {
    ...
    it("logWarning should log warnings once", (): void => {
      const msg = "Test warning";
      logWarning(msg);
      logWarning(msg);
    ...
    it("logWarning should include component name", (): void => {
      logWarning("Test", "Component");
